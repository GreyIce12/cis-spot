	...
	return(
		...
		<div className=" basis-1/4 items-center justify-start ">
			...
			<div className="flex justify-center items-center flex-wrap flex-col">
				 ...
				 { value.map((news) => {
					return (
						<Link className='cursor-pointer space-x-4 transition ease-in-out delay-150 hover:bg-gray-300 bg-blue-100 hover:-translate-y-1  hover:scale-110' key={news.key} href={`${news?.url}`} prefetch={false} >
