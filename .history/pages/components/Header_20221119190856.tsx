...
function Header() {
  ...
  return (
   ...
   <div className='flex flex-col space-x-2 space-y-2' >
    ...
    <Image objectFit='contain' src="http://cis.ncu.edu.jm/edtech/images/logo.png" layout="fixed" />
...
<div onClick={() =>signOut()} className=' cursor-pointer items-center space-x-2   p-2 lg:flex' >
