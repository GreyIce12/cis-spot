				 ...
				 { value.map((news) => {
					return (
						<Link className='cursor-pointer space-x-4 ' key={news.key} href={`${news?.url}`} prefetch={false} >
							<div className="flex items-center ml-2 transition ease-in-out delay-150 hover:bg-blue-300  hover:-translate-y-1  hover:scale-100  p-2 cursor-pointer space-x-2 md:w-80 md:h-40">
