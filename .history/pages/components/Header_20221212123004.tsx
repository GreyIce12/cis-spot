            ...
            <>
              ...
              >
                <ul className="flex flex-col p-4 mt-4 border basis-1/3 border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  ...
                  <li>
                    <a href="/" className="block lg:hidden py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100" aria-current="page">Home</a>
                  </li>
                  <li>
                    <a href="#" className="block lg:hidden py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 ">Program Gems</a>
                  </li>
                  <li>
                    <a href="#" className="block lg:hidden py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100">Tech Innovations</a>
                  </li>
                  <li>
                    <a href="#" className="block lg:hidden py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100">Contact</a>
                  </li>
