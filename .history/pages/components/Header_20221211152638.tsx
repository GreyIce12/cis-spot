...
function Header() {
  ...
  return (
    ...
    <><nav className="bg-white sticky border-gray-200 shadow-sm top-0 px-2 sm:px-4 py-2.5 rounded z-50">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        {session ? (
          ...
          <button onClick={() =>{setIsOpen(!isOpen)}}  type="button" className="flex  mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
            <span className="sr-only">Open user menu</span>
            <Image className=" rounded-full " src={session?.user?.image} objectFit="contain" width="60px" height="60px" alt="user photo" />
      ...
      <div className="items-center justify-between  basis-1/3 hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
    <ul className="flex flex-col p-4 mt-4 border basis-1/3 border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
     ...
     <> <div className="flex items-center md:order-2 basis-1/3 ">
