              ...
              >
                ...
                <ul className="flex flex-col p-4 mt-4 border basis-1/3 border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  ...
                  ?.map((post:any) =>{
                    ...
                    <li><a href={`/channel/${post.channels[0]?.topic}`} className=" absolute top-6 z-99  bg-blue-600 block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100" aria-current="page">{post.title}</a></li> 
                  })):
                  ( 
                  ...
                  <li>
                    <a href="#" className="block md:hidden lg:hidden py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100">Tech Innovations</a>
                  </li>
                  <li>
