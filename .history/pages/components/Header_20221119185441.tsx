...
function Header() {
  ...
  return (
    ...
    <div className="flex items-center text-2xl text-blue-500 font-medium">
        <h4>CIS SPOT</h4>
    </div>
    ...
    <MenuIcon className="h-7 w-7" />
        ...
        <form className="flex flex-1 items-center space-x-6 rounded border border-gray-200 px-3 py-1">
