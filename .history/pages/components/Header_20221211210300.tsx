            ...
            <>
              ...
              >
                <ul className="flex flex-col p-4 mt-4 border basis-1/3 border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  ...
                  <li>
                    <a href="#" className="block lg:hidden py-2 pl-3 pr-4 text-white" aria-current="page">Home</a>
                  </li>
                  <li>
                    <a href="#" className="block lg:hidden py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 dark:hover:text-white">Services</a>
                  </li>
                  <li>
                    <a href="#" className="block lg:hidden py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100">Pricing</a>
                  </li>
                  <li>
                    <a href="#" className="block lg:hidden py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Contact</a>
                  </li>
