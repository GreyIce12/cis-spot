    ...
    <>
      <nav className="bg-white sticky border-gray-200 shadow-sm top-0 py-3 px-2 sm:px-4  rounded z-50">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          <Link href="/" className="flex items-center basis-1/3 cursor-pointer">
            <>
              <img
                ...
                alt="CIS Logo"
              />
              <span className="self-center justify-start text-xl text-blue-500 font-semibold whitespace-nowrap ">
                CIS SPOT
              </span>
            </>
          </Link>
