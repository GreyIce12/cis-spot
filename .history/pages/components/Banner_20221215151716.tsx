...
function Banner({img, topic, summary}:Props) {
  return (
    <div className="bg-cover bg-center  h-auto text-white py-24 px-10 object-fill transition ease-in-out delay-150  hover:-translate-y-1  hover:scale-110" style={{backgroundImage: 'Url('+`${img}`+')'}}>
