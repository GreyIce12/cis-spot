...
function Header() {
  ...
  return (
    <>
      <nav className="bg-white sticky border-gray-200 shadow-sm top-0 py-1 px-2  lg:py-0 sm:px-4  rounded z-50">
                  ...
                  <ul className="py-1" aria-labelledby="user-menu-button">
                    <li>
                      <a
                        href="/"
                        onClick={() => signIn()}
                        className="inline px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 relative"
                      >
                        Sign In
                      </a>
                    </li>
