...
function Header({topic}: Props) {
  ...
  return (
    <>
      <nav className="bg-white sticky top-0 border-gray-200 shadow-sm  m-w-100 py-1 px-2  lg:py-0 sm:px-4 z-50">
            ...
            <>
              ...
              >
                ...
                <ul className="flex flex-col p-4 mt-4 border basis-1/3 border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  <>
                  <form onSubmit={handleSubmit} className="flex flex-1 items-center basis-1/3 space-x-2 rounded-md border-none border-gray-500 px-3 py-1"> 
                  ...
                  <li>
                    <Link href={"/pages/tech/Innovations"}>
                    <a href="/pages/tech/Innovations" className="block md:hidden lg:hidden py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100">Tech Innovations</a>
                    </Link>
                  </li>
                  <li>
