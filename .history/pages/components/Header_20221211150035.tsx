          ...
          <div className={clsx('z-50 text-base list-none bg-white divide-y divide-gray-100 rounded shadow', {
            ...
            'my-4': isOpen
              ...
              <ul className="py-1" aria-labelledby="user-menu-button">
                ...
                <li>
                  <a href="/" onClick={() => signOut()} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</Link>
                </li>
              </ul>
            </div>
