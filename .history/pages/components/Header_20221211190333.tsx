...
function Header() {
  ...
  return (
    <>
      <nav className="bg-white sticky border-gray-200 shadow-sm top-0 px-2 sm:px-4  rounded z-50">
            ...
            <>
              ...
              >
                <ul className="flex flex-col p-4 mt-4 border basis-1/3 border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  <form className="flex flex-1 items-center basis-1/3 space-x-2 rounded-md border-none border-gray-200 px-3 py-1">
                    <input
                      type="text"
                      placeholder="Search"
