...
export default function Innovations({value}:Value) {
 ...
 <Sidebar />
  ...
  <div className='flex flex-wrap justify-evenly items-center basis-3/4 space-x-2' >
    ...
    return(
<div key={news?.key} className="max-w-sm transition ease-in-out delay-150 bg-blue-00 hover:-translate-y-1 hover:scale-110 hover:bg-gray-300 duration-300 border p-10 m-10 top-2 border-gray-200 rounded-lg shadow-md w-400 h-400 ">
    <a href={news?.link}>
